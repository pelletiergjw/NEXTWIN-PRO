      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-3 px-4 py-1.5 mb-6 bg-orange-500/10 border border-orange-500/20 rounded-full">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-orange-400">
                PROTocole NEXTWIN V13 - REALITY CHECK
            </span>
        </div>
        <h1 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight">
          {t('daily_picks_title')}
        </h1>
        <p className="text-gray-400 font-medium italic">Mission de vérification via Google Search. Seuls les matchs 100% confirmés sont affichés.</p>
      </div>
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-24 gap-8">
          ...
          <div className="text-center space-y-2">
            <p className="text-orange-400 font-black uppercase tracking-widest text-sm animate-pulse">Scan des calendriers officiels en cours...</p>
          </div>
        </div>
      ) : picks.length > 0 ? (
        ...
        <Card className="max-w-xl mx-auto text-center py-16 border-dashed border-gray-700">
            ...
            <h3 className="text-xl font-black text-white mb-2">Aucun match confirmé trouvé</h3>
            <p className="text-gray-500 text-sm mb-8">L'IA n'a trouvé aucun match majeur répondant aux critères de vérification stricts pour aujourd'hui. Par sécurité, aucun pronostic n'est affiché.</p>
    ...
    <Card className="flex flex-col h-full border-gray-800/40 hover:border-orange-500/30 transition-all rounded-[2rem] p-8 bg-[#1C1C2B] group shadow-xl">
      <div className="flex justify-between items-start mb-6">
        <div className="flex flex-col">
            ...
            <span className="text-[8px] font-bold text-gray-500 uppercase tracking-widest">100% VÉRIFIÉ</span>
        </div>
        ...
        {pick.sourceUrl && (
            <div className="pt-2">
                ...
                >
                    ...
                    Vérifier sur Source Officielle
                </a>
            </div>
        )}
      </div>
