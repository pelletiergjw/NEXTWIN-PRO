...
const AnalysisPage: React.FC = () => {
  ...
  const loadingSteps = [
    "Connexion au moteur NextWin...",
    "Recherche des news de dernière minute...",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-black text-white mb-2 tracking-tight">Analyseur de Match <span className="text-orange-500">v4.2</span></h1>
        <p className="text-gray-500 uppercase text-[10px] font-bold tracking-[0.3em]">Moteur de prédiction temps réel (Stable)</p>
      </div>
            ...
            {isLoading ? (
                ...
                <div className="flex-grow flex flex-col items-center justify-center p-12 text-center space-y-8 animate-fadeIn">
                    ...
                    <div className="max-w-sm">
                        <h3 className="text-2xl font-black text-white mb-4">Analyse Interrompue</h3>
                        <p className="text-gray-400 font-medium leading-relaxed mb-8">{error}</p>
                        <Button onClick={() => { setError(null); handleSubmit(new Event('submit') as any); }} className="w-full py-4 text-xs font-black uppercase tracking-widest bg-white/5 border border-white/10 hover:bg-white/10">Réessayer maintenant</Button>
                    </div>
                </div>
            ) : analysisResult ? (
                <div className="space-y-6 p-6 md:p-10 animate-fadeIn">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1 bg-green-500/10 border border-green-500/20 rounded-full">
                            ...
                            <span className="text-[9px] uppercase font-black text-green-400 tracking-widest">Temps Réel Actif</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 p-6 rounded-3xl flex items-center gap-6 border border-white/5">
                        ...
                        <div>
                            <p className="text-[10px] uppercase font-black text-orange-500 tracking-widest">Date du Match</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white/5 p-6 rounded-3xl border border-white/5">
                            <h3 className="text-[10px] uppercase text-gray-500 font-black mb-4 tracking-widest">Fiabilité</h3>
                        ...
                        <div className="bg-white/5 p-6 rounded-3xl border border-white/5">
                            <h3 className="text-[10px] uppercase text-gray-500 font-black mb-4 tracking-widest">Risque</h3>
                    ...
                    <div className="bg-[#10101A] p-8 rounded-[2rem] border border-white/5">
                        ...
                        <div className="p-4 bg-orange-500/5 rounded-2xl border border-orange-500/20 italic text-sm text-orange-200">
                           <span className="font-bold uppercase text-[10px] block not-italic text-orange-400 mb-1">Verdict final</span>
                    ...
                    {analysisResult.sources && (
                        <div className="flex flex-wrap gap-2 pt-4">
                            {analysisResult.sources.map((s, i) => (
                                <a key={i} href={s.uri} target="_blank" rel="noopener noreferrer" className="text-[9px] bg-gray-900/80 text-gray-400 px-4 py-2 rounded-xl border border-white/5 hover:border-orange-500/40 hover:text-white transition-all truncate max-w-[200px]">
                                    🔗 {s.title}
                                </a>
                            ))}
                        </div>
                ...
                <div className="flex-grow flex flex-col items-center justify-center opacity-40 text-center">
                    ...
                    <p className="text-xs font-black uppercase tracking-[0.4em] text-gray-600">En attente de vos paramètres</p>
                </div>
            )}
            </Card>
        </div>
