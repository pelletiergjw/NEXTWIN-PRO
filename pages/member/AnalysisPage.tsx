  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 uppercase text-[10px] font-bold tracking-[0.3em]">Moteur d'Intelligence Sportive</p>
      </div>
        ...
        <div className="lg:col-span-5">
            <Card className="border-gray-800 shadow-2xl bg-[#1C1C2B] rounded-[2rem] p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Select id="sport" label="1. Discipline" value={selectedSport?.key || ''} onChange={handleSportChange}>
                    ...
                    <Button type="submit" disabled={isLoading} className="w-full py-5 text-lg font-black uppercase shadow-xl shadow-orange-500/20 rounded-2xl">
                        {isLoading ? "Recherche en cours..." : "Lancer l'Analyse Expert"}
                    </Button>
                </form>
            </Card>
        </div>
            ...
            {isLoading ? (
                <div className="flex-grow flex flex-col items-center justify-center py-20 gap-8">
                    ...
                    <div className="text-center space-y-3 px-6">
                        ...
                        <p className="text-gray-600 text-[10px] font-bold tracking-widest">VALIDATION DES DONNÉES TEMPS RÉEL...</p>
                    </div>
                </div>
            ) : error ? (
                <div className="flex-grow flex flex-col items-center justify-center p-12 text-center space-y-6">
                    <div className="w-16 h-16 bg-orange-500/10 rounded-full flex items-center justify-center text-3xl border border-orange-500/20">⚠️</div>
                ...
                <div className="space-y-6 p-6 md:p-10 animate-fadeIn">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white/5 p-6 rounded-3xl border border-white/5">
                            <h3 className="text-[10px] uppercase text-gray-500 font-black mb-4 tracking-widest">Indice de Confiance</h3>
                        ...
                        <div className="bg-white/5 p-6 rounded-3xl border border-white/5">
                            ...
                            <p className="text-[9px] text-gray-600 font-bold uppercase">Coup d'envoi : {analysisResult.matchDate} à {analysisResult.matchTime}</p>
                        </div>
                    </div>

                    <div className="bg-[#10101A] p-8 rounded-[2rem] border border-white/5">
                        <h3 className="text-[11px] uppercase text-orange-500 font-black mb-4 tracking-[0.2em]">Rapport Technique</h3>
                ...
                <div className="flex-grow flex flex-col items-center justify-center opacity-40 text-center">
                    ...
                    <p className="text-xs font-black uppercase tracking-[0.4em] text-gray-600">En attente de configuration</p>
                </div>
            )}
            </Card>
        </div>
